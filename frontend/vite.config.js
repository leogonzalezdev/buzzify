...
export default defineConfig({
  plugins: [
    ...
    VitePWA({
      ...
      manifest: {
        name: 'Buzzify - Real Time Chat',
        short_name: 'Buzzify',
        description: 'Buzzify: Una aplicación de chat en tiempo real que ofrece comunicación rápida, segura y moderna con notificaciones instantáneas y mensajes encriptados.',
        theme_color: '#ffffff',
